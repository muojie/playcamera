...
import static org.yanzi.playcamera.util.ShaderUtil.createProgram;
...
{	
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("vertex_six_point_star.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_six_point_star.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
